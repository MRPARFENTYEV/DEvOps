...
**Текущий этап:** инфраструктура, кластер, мониторинг и приложение развёрнуты вручную и работают
(ссылки в разделе 7). Осталось: **push в GitHub** и прогон **пайплайнов** (пункты CI-CD-terraform и CI/CD
